...
// A board beyond the solver's current algorithms (naked/hidden singles only)
const HARD_BOARD =
    "018050000060000049900207000700006030000308000030500007000709004450000070000020360";
